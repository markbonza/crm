...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title><?=isset($page_title) ? ucfirst($page_title) : SITE_NAME ?> | <?=SITE_DESCRIPTION?></title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">

	<link rel="icon" type="image/png" href="<?php echo base_url();?>favicon2.png" sizes="32x32" />
    ...
    <link href="<?=site_url('assets/plugins/waitme/waitMe.min.css')?>" rel="stylesheet">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=site_url('admin/dashboard')?>"><?=SITE_NAME?></a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!-- #END# Notifications -->
                    <li><p style="color: #fff;padding: 7px 7px 2px 7px;margin-top: 19px;margin-left: 5px;line-height: 20px;font-size: 18px;"><?php echo date('F d, Y');?></p></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header row">
                <h2><?=isset($page_title) ? strtoupper($page_title).(isset($page_description) ? '<small>'.$page_description.'</small>' : '') : 'No Page Title'?></h2>
            </div>
            <?php if($this->session->flashdata('access_error')){
			  echo '<div class="alert alert-danger">';
				echo '<a class="close" data-dismiss="alert">×</a>';
				echo $this->session->flashdata('access_error');
			  echo '</div>';          
